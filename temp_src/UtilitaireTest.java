...
public class UtilitaireTest {
    public static boolean envoyerEmail(String sender,String mdp, String email, String htmlString) throws Exception {
        try {
            String var1 = "girlspower434@gmail.com";  // Adresse de l'expéditeur
            String var2 = "sjgu swux jdhb ghld";  // Mot de passe de l'expéditeur
            String var3 = email;  // Destinataire du mail

            if(!var1.equals(sender)){
                throw new Exception("Tsy mitovy email");
            }if(!var2.equals(mdp)){
                throw new Exception("Tsy mitovy mdp");
            }
